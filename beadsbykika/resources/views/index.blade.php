...
<body>
    ...
    <div id="splash-screen">
        <img src="assets/BEADSBYKIKA-LOGO.png" alt="Beads by Kika Logo" class="splash-logo">
    </div>
    ...
    <div id="home-page" style="display: none;">
        ...
        <header class="header">
            <div class="header-container">
                ...
                <!-- Logo in the Center -->
                <img src="assets/BEADSBYKIKA-LOGO.png" alt="Beads by Kika Logo" class="logo">
    ...
    <!-- Hero Section -->
    <section class="hero">
        <img src="assets/kika1.png" alt="Hero Image" class="hero-image">
    ...
    <section class="Rproduct">
        ...
        <div class="Rproduct-container">
            <div class="Rproduct-item" onclick="openModal('product1', 'assets/kika.png')">
                <img src="assets/kika.png" alt="Product 1" />
                <h3>Product 1</h3>
                <p>Price: $29.99</p>
                <div class="rating">⭐⭐⭐⭐⭐</div>
            </div>
            <div class="Rproduct-item" onclick="openModal('product2', 'assets/kika.png')">
                <img src="assets/kika.png" alt="Product 2" />
                <h3>Product 2</h3>
                <p>Price: $39.99</p>
                <div class="rating">⭐⭐⭐⭐⭐</div>
            </div>
    ...
    <!-- Modal for Product Color Selection -->
    <div id="colorModal" class="modal">
        <div class="modal-content">
            <span class="close" onclick="closeModal()">&times;</span>
            <h2>Select Color</h2>
            <!--<button onclick="viewImage()">View Larger Image</button> -->
    ...
    <div id="imageModal" class="modal">
        <div class="modal-content">
            ...
            <img id="largeProductImage" src="" alt="Large Product Image" class="large-product-image" />
        </div>
